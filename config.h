...
#define DEFAULT_WIFI_SSID ""                               // [NVS] wifi_ssid
#define DEFAULT_WIFI_PASS ""                               // [NVS] wifi_pass
#define DEFAULT_AP_PASS DEFAULT_AP_PASSWORD                // [NVS] ap_pass
#define DEFAULT_FB_API_KEY ""                              // [NVS] fb_api
#define DEFAULT_FB_PROJECT ""                              // [NVS] fb_proj
#define DEFAULT_FB_EMAIL ""                                // [NVS] fb_email
#define DEFAULT_FB_PASS ""                                 // [NVS] fb_pass
